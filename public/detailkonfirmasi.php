  ...
  <body id="page-top">
    ...
    ?>
      ...
      if(isset($_GET['idk'])){
        ...
        $idk = mysqli_query($koneksi,"select * from konfirmasi where idk='$idk'");
      }else{
        $idk = mysqli_query($koneksi,"select * from konfirmasi");
      }
      
      while($data = mysqli_fetch_array($idk)){
      ?>
      <table>
      <tr>
        <img src='img/<?php echo $data['fotok']; ?>' border="0">
        <hr>
      </tr>
      </table>
      ...
      <tr>
        <td>Jenis Bencana  :</td>
        <td><?php echo $data['jenisbencanak']; ?></td>
      </tr>
      <tr>
        <td>Lokasi Bencana:</td>
        <td><?php echo $data['lokasibencanak']; ?></td>
      </tr>
      <tr>
        <td>Nama pelapor:</td>
        <td><?php echo $data['namapelapork']; ?></td>
      </tr>
      <tr>
        <td>Alamat Pelapor:</td>
        <td><?php echo $data['alamatpelapork']; ?></td>
      </tr>
      <tr>
