  ...
  <body id="page-top">
    ...
    ?>
      ...
      if(isset($_GET['idd'])){
        ...
        $idd = mysqli_query($koneksi,"select * from laporan where idd='$idd'");
      }else{
        $idd = mysqli_query($koneksi,"select * from laporan");
      }
      
      while($data = mysqli_fetch_array($idd)){
      ?>
      <table>
      <tr>
        <img src='img/<?php echo $data['fto']; ?>' border="0">
        <hr>
      </tr>
      </table>
      ...
      <tr>
        <td>Jenis Bencana  :</td>
        <td><?php echo $data['jeben']; ?></td>
      </tr>
      <tr>
        <td>Lokasi Bencana:</td>
        <td><?php echo $data['loben']; ?></td>
      </tr>
      <tr>
        <td>Nama pelapor:</td>
        <td><?php echo $data['napel']; ?></td>
      </tr>
      <tr>
        <td>Alamat Pelapor:</td>
        <td><?php echo $data['alpel']; ?></td>
      </tr>
      <tr>
