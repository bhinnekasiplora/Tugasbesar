  ...
  <body id="page-top">
    ...
    ?>
      ...
      if(isset($_GET['idi'])){
        ...
        $idi = mysqli_query($koneksi,"select * from istruksi where idi='$idi'");
      }else{
        $idi = mysqli_query($koneksi,"select * from istruksi");
      }
      
      while($data = mysqli_fetch_array($idi)){
      ?>
      <table>
      <tr>
        <img src='img/<?php echo $data['fotoi']; ?>' border="0">
        <hr>
      </tr>
      </table>
      ...
      <tr>
        <td>Kode Laporan:</td>
        <td><?php echo $data['idi']; ?></td>
      </tr>
      <tr>
        <td>Tanggal:</td>
        <td><?php echo $data['tanggali']; ?></td>
      </tr>
      <tr>
        <td>Jenis Bencana  :</td>
        <td><?php echo $data['jenisbencanai']; ?></td>
      </tr>
      <tr>
        <td>Lokasi Bencana:</td>
        <td><?php echo $data['lokasibencanai']; ?></td>
      </tr>
      <tr>
        <td>Nama pelapor:</td>
        <td><?php echo $data['namapelapori']; ?></td>
      </tr>
      <tr>
        <td>Alamat Pelapor:</td>
        <td><?php echo $data['alamatpelapori']; ?></td>
      </tr>
      <tr>
        <td>Deskripsi Laporan:</td>
        <td><?php echo $data['deskripsii']; ?></td>
      </tr>
      <?php 
      }
      ?>
