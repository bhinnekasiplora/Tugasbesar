  ...
  <body id="page-top">
    ...
    ?>
      ...
      if(isset($_GET['id'])){
        ...
        $id = mysqli_query($koneksi,"select * from laporanbencana where id='$id'");
      }else{
        $id = mysqli_query($koneksi,"select * from laporanbencana");
      }
      ...
      <table>
      <tr>
        <img src='img/<?php echo $data['foto']; ?>' border="0">
        <hr>
      </tr>
      </table>
      ...
      <tr>
        <td>Jenis Bencana  :</td>
        <td><?php echo $data['jenisbencana']; ?></td>
      </tr>
      <tr>
        <td>Lokasi Bencana:</td>
        <td><?php echo $data['lokasibencana']; ?></td>
      </tr>
      <tr>
        <td>Nama pelapor:</td>
