...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section id="contact">
      <div class="container">
        <hr>
        <h2 class="text-center text-uppercase text-secondary mb-0">Beranda</h2>
        <hr class="">

        <div class="row">
          <div class="image col-md-4">
            <img style= "margin-bottom: 30px;width: 65%;"align="center" src="img/Logobpbd.jpg">
          </div>
          <div class="col-md-8" style="padding-top: 5%">
           
              <h4><b>Visi</b></h4>
            
                Terwujudnya masyarakat Sleman yang lebih Sejahtera, Mandiri, Berbudaya dan Terintegrasikannya system e-government menuju smart regency pada tahun 2021
           
             
              <h4><b>Misi</b></h4>
                Meningkatkan tata kelola tata pemerintahan yang baik melalui peningkatan kualitas birokrasi yang responsif dan penerapan e-govt yang terintegerasi dalam memberikan pelayanan bagi masyarakat.<br><br>
              
              
                Memantapkan dan meningkatkan kualitas sumberdaya alam, penataan ruang, lingkungan hidup dan kenyamanan
