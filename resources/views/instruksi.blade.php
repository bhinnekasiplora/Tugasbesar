...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section id="contact">
      <div class="container">
        <hr>
        <h2 class="text-center text-uppercase text-secondary mb-0">Instruksi Laporan</h2>
    ...
    <tr>
      ...
      <?php
        ...
        while($laporan = mysqli_fetch_array($query)){
            ...
            echo "<td>";
            echo "<a href='hapusinstruksi.php?idi=".$laporan['idi']."'>Hapus | </a>";
            echo "<a href='teskirimik.php?idi=".$laporan['idi']."' >Perintahkan</a>";
            echo "</td>";
            echo "<td>";
  ...
  <!-- <a href="/laporaninstruksi" class="btn btn-primary">Teruskan Kedinas</a> -->
          </div>
        </div>
      </div>
    </section>
