...
<!--           <ul class="navbar-nav ml-auto">
    ...
    <section id="contact">
      <div class="container">
        <hr>
        <h3 class="text-center text-uppercase text-secondary mb-0">Pendaftaran BNPB</h3>
...
<form method="post" name="pendaftaran" action="proses_daftarController.php">
...
<tr>
<td colspan=2>&nbsp;</td>
<td><input type="submit" name="submit" href"" value="DAFTAR"></td>
</tr>
<tr>
