...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section id="contact">
      <div class="container">
        <hr>
        <h2 class="text-center text-uppercase text-secondary mb-0">Laporan Lokasi rawan bencana</h2>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <!-- The form should work on most web servers, but if the form is not working you may need to configure your web server differently. -->
              ...
              <h3 class="controls mb-0 pb-2">Data Diri</h3>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="name" name="namapelapor" class="form-control" placeholder="Nama Pelapor">
              </div>

              <div class="form-group col-md-6">
                <label for="alamatpelaporan">Alamat Pelapor</label>
                <input type="text" name="alamatpelapor" class="form-control" placeholder="Alamat Pelapor">
              </div>
            </div>
            <h3 class="controls mb-0 pb-2">Informasi Bencana</h3>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="jenisbencana" id="inputAddress" placeholder="Jenis Bencana">
            </div>
            <div class="form-group">
              <label for="lokasibencana">Lokasi Bencana</label>
              <input type="text" class="form-control" name="lokasibencana" id="inputAddress" placeholder="Lokasi Bencana">
            </div>
            <div class="form-group">
            <label for="deskripsi">Deskripsi Laporan</label>
            <textarea type="text" class="form-control" name="deskripsi" id="exampleFormControlTextarea1" rows="3"></textarea>
           </div>
            <div class="form-group">
              <label for="foto">Masukkan Foto</label>
              <input type="file" class="form-control-file"  name="foto" id="foto" placeholder="foto">
            </div>
              <input href="/pesanlaporan" type="submit" name="lapor" value="Lapor" class="btn btn-primary" >
            </fieldset>
          </form>
          </div>
        </div>
