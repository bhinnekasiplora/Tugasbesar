...
<!--           <ul class="navbar-nav ml-auto">
    ...
    <section id="contact">
      <div class="container">
        <hr>
        <h3 class="text-center text-uppercase text-secondary mb-0">Pendaftaran BDPB</h3>
...
<form method="post" name="pendaftaran" action="proses_daftarbdbpController.php">
<table border=0 align="center" cellpadding=5 cellspacing=0>
<tr>
<td colspan=3><center><font size=5></font></center></td>
</tr>
<tr>
<td>Nama</td><td>:</td><td><input type="text" name="namabdpb"></td>
</tr>
<tr>
<td>Email</td><td>:</td><td><input type="text" name="emailbdpb"></td>
</tr>
<tr>
<td>Username</td><td>:</td><td><input type="text" name="usernamebdpb"></td>
</tr>
<tr>
<td>Password</td><td>:</td><td><input type="password" name="passwordbdpb"></td>
</tr>
<tr>
<td colspan=2>&nbsp;</td>
