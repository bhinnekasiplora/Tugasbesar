...
<!--           <ul class="navbar-nav ml-auto">
    ...
    <section id="contact">
      <div class="container">
        <hr>
        <h3 class="text-center text-uppercase text-secondary mb-0">Pendaftaran DINAS</h3>
...
<form method="post" name="pendaftaran" action="proses_daftardinasController.php">
<table border=0 align="center" cellpadding=5 cellspacing=0>
<tr>
<td colspan=3><center><font size=5></font></center></td>
</tr>
<tr>
<td>Nama</td><td>:</td><td><input type="text" name="namadinas"></td>
</tr>
<tr>
<td>Email</td><td>:</td><td><input type="text" name="emaildinas"></td>
</tr>
<tr>
<td>Username</td><td>:</td><td><input type="text" name="usernamedinas"></td>
</tr>
<tr>
<td>Password</td><td>:</td><td><input type="password" name="passworddinas"></td>
</tr>
<tr>
<td colspan=2>&nbsp;</td>
...
<tr>
<td colspan=3><a href="/index">LOGIN</a></td>
</tr>
</table>
</form>
