...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section id="contact">
      <div class="container">
        <hr>
        <h2 class="text-center text-uppercase text-secondary mb-0">Rekapitulasi Laporan</h2>
    ...
    <tr>
      ...
      $no=1;
        ...
        while($laporan = mysqli_fetch_array($query)){
            echo "<tr>";
            echo "<td>".$no++."</td>";    
            echo "<td>".$laporan['idv']."</td>";
            echo "<td>".$laporan['tanggalv']."</td>";
            echo "<td>".$laporan['jenisbencanav']."</td>";
            echo "<td>".$laporan['lokasibencanav']."</td>";
            echo "<td>".$laporan['namapelaporv']."</td>";
            echo "<td>";
            echo "<a href='detailvalidasi.php?idv=".$laporan['idv']."' >Detail</a>";
            echo "</td>";
            echo "</tr>";
        }
             include("config.php");
        $sql = "SELECT * FROM istruksi";
        $query = mysqli_query($db, $sql);

        while($laporan = mysqli_fetch_array($query)){
            echo "<tr>";
            echo "<td>".$no++."</td>";  
            echo "<td>".$laporan['idi']."</td>";
            echo "<td>".$laporan['tanggali']."</td>";
            echo "<td>".$laporan['jenisbencanai']."</td>";
            echo "<td>".$laporan['lokasibencanai']."</td>";
            echo "<td>".$laporan['namapelapori']."</td>";
            echo "<td>";
            echo "<a href='detailinstruksi.php?idi=".$laporan['idi']."' >Detail</a>";
            echo "</td>";
