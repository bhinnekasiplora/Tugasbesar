...
<html lang="en">
    ...
    <tr>
      ...
      $no=1;
        ...
        while($laporan = mysqli_fetch_array($query)){
            ...
            echo "<a href='hapusmanajer.php?idd=".$laporan['idd']."'>Hapus | </a>";
            echo "<a href='teskirimmv.php?idd=".$laporan['idd']."' >Alihkan</a>";
            echo "</td>";
            echo "<td>";
            echo "<a href='detailmanajer.php?idd=".$laporan['idd']."' >Detail</a>";
            echo "</td>";
 ...
 <!--  <a href="/konfirmasidaerah" class="btn btn-primary">Teruskan Kedaerah</a> -->
          </div>
        </div>
      </div>
    </section>
